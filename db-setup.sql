...
create or replace procedure sandbox.COMPARE_MISMATCH_IGNORE_EXCLUDED_COL(HIVE_SCHEMA String, SF_SCHEMA String, T1 String, T2 String, ID_COL STRING, ID_VAL STRING)
returns ARRAY
language JAVASCRIPT
AS $$
...
call COMPARE_MISMATCH_IGNORE_EXCLUDED_COL('SANDBOX', 'SANDBOX', 'DELTA_STAGE_CUSTOMER_RK', 'CUSTOMER_RK', 'ID', 'FTP_CSV_11_67E7A4881A42DC7A419D1332E7');
